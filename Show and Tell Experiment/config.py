...
class Config(object):
    ...
    def __init__(self):
        ...
        self.num_initalize_layers = 2 ## Changed from 2 to 1    # 1 or 2
        self.dim_initalize_layer = 512
        self.num_attend_layers = 2       # 1 or 2
        self.dim_attend_layer = 512
        self.num_decode_layers = 2    ## Changed from 2 to 1   # 1 or 2
        ...
        self.initial_learning_rate = 0.001 #was 0.0001
        ...
        self.vocabulary_size = 1152

        # about the training
        self.train_image_dir = './train/images/'
        self.train_caption_file = './train/train_2.json'
        self.temp_annotation_file = './train/anns.csv'
        self.temp_data_file = './train/data.npy'

        # about the evaluation
        self.eval_image_dir = './val/images_val/'
        self.eval_caption_file = './val/vali_2.json'
        self.eval_result_dir = './val/results/'
        self.eval_result_file = './val/vali_2.json'
